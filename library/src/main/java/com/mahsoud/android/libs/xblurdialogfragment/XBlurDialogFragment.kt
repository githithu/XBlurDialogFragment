...
/**
 * Encapsulate dialog behavior with blur effect for app using [android.app.DialogFragment].
 *
 *
 * All the screen behind the dialog will be blurred except the action bar.
 */
@TargetApi(Build.VERSION_CODES.HONEYCOMB)
abstract class XBlurDialogFragment : DialogFragment() {

    /**
     * Engine used to blur.
     */
    private var mBlurEngine: XBlurDialogEngine? = null
     ...
     */
    /*protected val isDebugEnable: Boolean
        get() = XBlurDialogEngine.DEFAULT_DEBUG_POLICY*/

    protected open fun isDebugEnable(): Boolean {
     ...
     */
    /*protected val downScaleFactor: Float
        get() = XBlurDialogEngine.DEFAULT_BLUR_DOWN_SCALE_FACTOR*/

    protected open fun getDownScaleFactor(): Float {
     ...
     */
    /*protected val blurRadius: Int
        get() = XBlurDialogEngine.DEFAULT_BLUR_RADIUS*/

    protected open fun getBlurRadius(): Int {
     ...
     */
    /*protected val isDimmingEnable: Boolean
        get() = XBlurDialogEngine.DEFAULT_DIMMING_POLICY*/

    protected open fun isDimmingEnable(): Boolean {
     ...
     */
    /*protected val isActionBarBlurred: Boolean
        get() = XBlurDialogEngine.DEFAULT_ACTION_BAR_BLUR*/

    protected open fun isActionBarBlurred(): Boolean {
     ...
     */
    protected val isRenderScriptEnable: Boolean
        get() = XBlurDialogEngine.DEFAULT_USE_RENDERSCRIPT
